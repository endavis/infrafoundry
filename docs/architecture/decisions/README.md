...
This directory contains Architecture Decision Records (ADRs) for InfraFoundry.

## List of Decisions

- [0000-template.md](0000-template.md): ADR Template
- [0001-repository-pattern-for-state.md](0001-repository-pattern-for-state.md): Use Repository Pattern for State Management
