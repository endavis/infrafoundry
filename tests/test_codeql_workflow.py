...
will stop PRs from merging. See pyproject-template#431 and infrafoundry
issue #637 for context (the migration from GitHub's "default setup" to
this advanced workflow file).
"""
...
class TestAnalyzeJob:
    ...
    def test_analyze_matrix_languages_exact(self) -> None:
        ...
        Expanding the language set is out of scope for pyproject-template#431 and requires a
...
class TestSummaryJob:
    ...
    This section is the core regression guard for pyproject-template#431: the name of the
